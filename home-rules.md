...
## Границы Повествования и Этикет

"Всё мне позволительно, но не всё полезно" - в нашем путешествии по другим мирам мы вольны касаться самых темных и приземленных сторон жизни, однако мы делаем это для создания глубины мира, а не ради самоцели.

* Секс и бордeли: в нашей игре мы придерживаемся принципа "Уход в затемнение" (Fade to Black). Описание процесса, подробности работы заведений и их прямой функционал остаются за кадром. 

* Карты (Таро): использование колод для гадания запрещено; выбираем иные методы прорицания.